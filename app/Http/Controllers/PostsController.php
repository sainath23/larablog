...
class PostsController extends Controller
{
    ...
    {
        /*$post = Post::all();
        $post = Post::where('title', 'First Post')->get();
    ...
    public function store(Request $request)
    {
        ...
        // Store data into post table through Post model using eloquent ORM
        $post = new Post();
    ...
    public function update(Request $request, $id)
    {
        ...
        // Update data into post table through Post model using eloquent ORM
        $post = Post::find($id);
        $post->title = $request->input('title');
        $post->body = $request->input('body');
        if($request->hasFile('cover_image')) {
